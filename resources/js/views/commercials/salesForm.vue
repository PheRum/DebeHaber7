              ...
              <b-col>
                ...
                <b-form-group label="Customer">
                  <b-input-group>
                    ...
                    <b-input type="text" v-model="search" placeholder="Search for Customer" @change="searchData()"/>
                    <b-list-group>
                      <b-list-group-item  v-for="customer in customers" @click="Select(customer)" :key="customer">{{customer.name}}</b-list-group-item>
  ...
  methods: {
    ...
    searchData()
    {
      ...
      if (app.search === '') {
        ...
        crud.methods
        .onRead('/api/PYG/get_taxpayers/' + app.search)
        .then(function (response) {
