                        ...
                        <b-row>
                            ...
                            <b-col>
                                ...
                                <b-form-group :label="$t('commercial.paymentCondition')">
                                    <b-input-group>
                                        <b-input type="number" :placeholder="$t('commercial.paymentCondition')" v-model.number="data.payment_condition"/>
                                ...
                                <b-form-group :label="$t('commercial.exchangeRate')">
                                    <b-input-group>
                                        ...
                                        <b-input type="number" :placeholder="$t('commercial.payment')" v-model.number="data.rate"/>
                                    </b-input-group>
                                </b-form-group>
                            </b-col>
                        </b-row>
